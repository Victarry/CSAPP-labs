...
# phase_2(string input_string[%rdi])
# rdi: input_string
# rsi: 
  400efc:	55                   	push   %rbx # Pass
  400efd:	53                   	push   %rbx # Pass
  400efe:	48 83 ec 28          	sub    $0x28,%rsp
  400f02:	48 89 e6             	mov    %rsp,%rsi # int nums[]
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers> # read_six_numers(input_string, int* nums)
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp) # first number should be 1
  400f0e:	74 20                	je     400f30 <phase_2+0x34> # 
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax # eax = nums[0]
  400f1a:	01 c0                	add    %eax,%eax # eax = 2*nums[0]
  400f1c:	39 03                	cmp    %eax,(%rbx) # nums[1] == 2 * nums[0]
  ...
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp # rbp = nums[6]
...
# x <= 7 and 
  ...
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt> # "%d %d" -> x, y
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> # if x > 7: gg
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax # eax = y
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8) # 
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>
  400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax # move to here! x/gx 0x402480
  ...
  400fcd:	c3                   	retq   
 # (a=%rdi, b=%rsi=0, c=%rdx=14) d = %rcx res = %rax
0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd4:	29 f0                	sub    %esi,%eax # res = d = c - a
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx # d = sign(d)
  400fdb:	01 c8                	add    %ecx,%eax # res = (res + d) // 2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # d = res + b + 1
  400fe2:	39 f9                	cmp    %edi,%ecx # test(d-a) # assert a < d
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx # c -= 1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4> # func(a, b, c)
  400fee:	01 c0                	add    %eax,%eax # res *= 2
  400ff0:	eb 15                	jmp    401007 <func4+0x39> # return
  ; 400ff2:	b8 00 00 00 00       	mov    $0x0,%eax # bomb
  ; 400ff7:	39 f9                	cmp    %edi,%ecx # a <= 14, return
...
000000000040100c <phase_4>:
  ...
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt> # "%d %d" -> x, y
  401029:	83 f8 02             	cmp    $0x2,%eax
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)
  401033:	76 05                	jbe    40103a <phase_4+0x2e> # x-14 <= 0
  ...
  401048:	e8 81 ff ff ff       	callq  400fce <func4> # func4(a, b, c)
  40104d:	85 c0                	test   %eax,%eax # assert eax > 0
...
# read_six_numbers(input_string, int* nums)
000000000040145c <read_six_numbers>:
  ...
  # rdi: input_string, rsi: format string, rdx: &nums[0], rcd: &nums[1], r8: &nums[2]
  # r9: &nums[3], rsp: &nums[4], rsp+8: &nums[5]
  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  40148f:	83 f8 05             	cmp    $0x5,%eax # test if has 5 numebrs
